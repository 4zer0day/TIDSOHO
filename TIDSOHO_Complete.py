...
def arpSpoof(target):
    ...
    os.system("arpspoof -i wlan0 -t "+ gw_ip +" -r "+ target[0])
...
def msg_scanip(update: Update, context: CallbackContext)-> None:
    ...
    try:
        ...
        context.bot.send_message(admin_chatid,"omething went wrong... Please try again.")
...
def main():
    ...
    bot = updater.bot
    bot.send_message(chat_id=admin_chatid, text="☄️ TELEGRAM-INTEGRATED INTRUSION DETECTION SYSTEM (IDS) FOR SMALL OFFICE HOME OFFICE (SOHO) WIRELESS NETWORK ☄️\n\n/help for more information")
